...
metadata {
    definition (name: "ZigBee Switch", namespace: "bluecolor90", author: "SmartThings", ocfDeviceType: "oic.d.switch", runLocally: true, minHubCoreVersion: '000.019.00012', executeCommandsLocally: true) {
        capability "Actuator"
...
def parse(String description) {
    ...
    log.debug "debugkjw>parse>zigbeegetevent>event val is $event"
    if (event) {
        sendEvent(event)
    }
    else {
